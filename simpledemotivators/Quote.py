...
class Quote:
    ...
    def get(self, file, result_filename='qresult.jpg', url=False, headline_font='verdana.ttf', headline_size=50,
            headline_text='Цитаты великих людей', name_font='times.ttf', name_size=40, text_font='arial.ttf',
            text_size=40):
